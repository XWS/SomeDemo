 ...
 */
class ViewHolder(private val mContext:Context,private val mConvertView:View) : RecyclerView.ViewHolder(mConvertView) {
    ...
    companion object {
        ...
        fun createViewHolder(context: Context,parent:ViewGroup,layoutId:Int) : ViewHolder{
            return ViewHolder(context,LayoutInflater.from(context).inflate(layoutId,parent,false))
        }
    }
...
//    }
    ...
    fun setChecked(viewId: Int, checked: Boolean): ViewHolder {
        val view = getView<CheckBox>(viewId) as Checkable
